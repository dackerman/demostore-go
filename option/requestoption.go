...
// RequestOption is an option for the requests made by the stainless store API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/dackerman-store-go#readme-requestoptions
