...
// interacting with the stainless store API. You should not instantiate this client
...
// DefaultClientOptions read from the environment (DEMOSTORE_API_KEY). This should
...
// environment (DEMOSTORE_API_KEY). The option passed in as arguments are applied
